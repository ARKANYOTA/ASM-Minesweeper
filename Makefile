...
clean:
	...
	@echo -e "\033[1m\033[94mNettoyage des anciens fichiers\033[0m"

asm-minesweeper:
	@nasm -felf64 asm-minesweeper.asm && ld asm-minesweeper.o -o asm-minesweeper
	@echo -e "\033[1m\033[92mCompilation\033[0m"
	@echo -e "\033[1m\033[92mFichier compilé et prêt à l'utilisation\033[0m"
